...
const text = {
  en: {
    ...
    photoNote: "Optional: If you think your car is in above-average condition, please take some photos. A dealer can review them for a more accurate follow-up.",
  ...
  fr: {
    ...
    photoNote: "Facultatif : si vous pensez que votre véhicule est dans un état supérieur à la moyenne, veuillez prendre quelques photos. Un concessionnaire pourra les examiner pour un suivi plus précis.",
